...
class Trainer:
    def __init__(self, Model: BaseGAN, cfg_path) -> None:
        ...
        tf_list = [
            ...
            tf.Resize((self.cfg.imsize, self.cfg.imsize),antialias=True),
        ]
    ...
    def train(self):
        ...
        for ep in enumerate(loop):
            # train epoch is in the base model
            # it calls the critic and generator step which are implemented in the model
